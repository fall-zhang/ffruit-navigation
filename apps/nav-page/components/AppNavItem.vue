<template>
  <div class="wrap website-item">
    <div class="link" target="_blank" @click="$emit('navClick', navData)">
...
const $emit = defineEmits(['handleNavStar', 'navClick'])
...
const navData = ref(props.data)
function handleNavStar () {
  $emit('handleNavStar', navData, () => {
